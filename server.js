...
const startQs = () => {
  ...
  addNewDept = () => {
    ...
    .then(response => {
      ...
      db.query(sql, [response.dep_name], (err, res) => {
        if (err) throw err;
        console.log(`You added ${response.dep_name} department at id ${res.insertId}!`);
  ...
  deleteDept = () => {
    ...
    db.query("SELECT * FROM department", (err, res) => {
      ...
      .then(response => {
        ...
        db.query(sql, [response.id, response.name], (err, res) => {
          if (err) throw err;
          console.log(`-------- You've Successfully Deleted ${res.affectedRows} row(s) --------!`);
          viewAllDepts();
        });
      });
    });
  ...
  deleteRole = () => {
    ...
    db.query("SELECT * FROM role", (err, res) => {
      ...
      .then(response => {
        ...
        db.query(sql, [response.id], (err, res) => {
          if (err) throw err;
          console.log(`-------- You've Successfully Deleted ${res.affectedRows} row(s)! --------`);
          viewAllEmployees();
        });
